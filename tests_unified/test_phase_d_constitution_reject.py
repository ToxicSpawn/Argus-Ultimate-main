...
def test_phase_d_flow_rejects_constitution_breach() -> None:
    with tempfile.NamedTemporaryFile() as journal_file, tempfile.NamedTemporaryFile() as ledger_file:
        ...
        intent_id = entry.submit_order(
            ...
            price=50000.0,
            equity=100000.0,
            symbol_notional_after=20000.0,
            cluster_notional_after=20000.0,
            gross_notional_after=20000.0,
        ...
        assert runtime.state[intent_id] == "RISK_REJECTED"
